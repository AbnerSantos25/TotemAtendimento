            ...
            <>
              ...
              <div className="grid gap-2">
                ...
                <div className="text-muted-foreground">
                  Mostrando o total de visitantes nos últimos 6 meses. Este é apenas um texto aleatório para testar o layout. Ele se estende por várias linhas e deve quebrar.
                </div>
              </div>
              <Separator />
            </>
