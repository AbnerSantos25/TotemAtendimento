...
namespace Totem.Application.Services.IdentityServices
{
	public interface IIdentityService
	{
		...
		Task<(Result Result, object Data)> RegisterUserAsync(RegisterUserView registerUserView);
		...
		Task<(Result Result, object Data)> LoginUserAsync(LoginUserView loginUserView);
